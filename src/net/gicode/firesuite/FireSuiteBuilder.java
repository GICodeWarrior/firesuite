...
public class FireSuiteBuilder {
  ...
  private final int numParallelTests;

  /**
   * Test suites generated by this builder execute two concurrent tests per
   * hardware thread.
   * 
  ...
  /**
   * Test suites generated by this builder execute with the specified
   * concurrency.
   * 
   * @param filter The definition of which tests to execute.
  ...
  private TestSuite[] buildSequentialSuites(List<TestCase> testCases) {
    TestSuite[] testSuites = new TestSuite[this.numParallelTests];
